...
def run_owned(argv, *, cwd, env, timeout_seconds, limit):
    ...
    try:
        ...
        # Do not leave observed children behind after a short-lived parent exits.
        children = {pid: fd for pid, fd in handles.items() if pid != process.pid and _alive(fd)}
